/*
  ...
  - The `language` column on the `Submissions` table would be dropped and recreated. This will lead to data loss if there is data in the column.
  - You are about to drop the `User` table. If the table is not empty, all the data it contains will be lost.

*/
-- CreateEnum
CREATE TYPE "LanguageType" AS ENUM ('CPP', 'JS', 'PY', 'RUST', 'GO');
...
ADD COLUMN     "language" "LanguageType" NOT NULL DEFAULT 'CPP';
